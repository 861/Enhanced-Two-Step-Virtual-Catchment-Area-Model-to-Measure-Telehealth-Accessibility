CREATE table glassy-automata-358521.access.od_pop as SELECT *, pop*1 ppotent from (select * from `glassy-automata-358521.access.od_900` od_900 join `glassy-automata-358521.access.pop` pop on pop.popid = od_900.orig);
...
CREATE table glassy-automata-358521.access.access_900_1 as SELECT orig, sum(R) acc900 from `glassy-automata-358521.access.ratio` GROUP BY orig;
