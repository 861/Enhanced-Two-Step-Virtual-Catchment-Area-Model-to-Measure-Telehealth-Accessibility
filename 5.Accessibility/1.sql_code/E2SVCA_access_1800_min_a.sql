CREATE table glassy-automata-358521.access.od_pop as SELECT *, pop*min_a_w ppotent from (select * from `glassy-automata-358521.access.od_1800_min_a` od_1800_min_a join `glassy-automata-358521.access.pop` pop on pop.popid = od_1800_min_a.orig);
...
CREATE table glassy-automata-358521.access.access_1800_min_a as SELECT orig, sum(R) acc1800 from `glassy-automata-358521.access.ratio` GROUP BY orig;
