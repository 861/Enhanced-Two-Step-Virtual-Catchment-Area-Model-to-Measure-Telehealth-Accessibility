CREATE table glassy-automata-358521.access.od_pop as SELECT *, pop*1 ppotent from (select * from `glassy-automata-358521.access.od_2700` od_2700 join `glassy-automata-358521.access.pop` pop on pop.popid = od_2700.orig);
...
CREATE table glassy-automata-358521.access.access_2700_1 as SELECT orig, sum(R) acc2700 from `glassy-automata-358521.access.ratio` GROUP BY orig;
