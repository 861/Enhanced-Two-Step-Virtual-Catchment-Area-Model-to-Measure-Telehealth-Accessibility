CREATE table glassy-automata-358521.access.od_pop as SELECT *, pop*1 ppotent from (select * from `glassy-automata-358521.access.od_3600` od_3600 join `glassy-automata-358521.access.pop` pop on pop.popid = od_3600.orig);
...
CREATE table glassy-automata-358521.access.access_3600_1 as SELECT orig, sum(R) acc3600 from `glassy-automata-358521.access.ratio` GROUP BY orig;
