CREATE table glassy-automata-358521.access.od_pop as SELECT *, pop*max_f_w ppotent from (select * from `glassy-automata-358521.access.od_2700_max_f` od_2700_max_f join `glassy-automata-358521.access.pop` pop on pop.popid = od_2700_max_f.orig);
...
CREATE table glassy-automata-358521.access.access_2700_max_f as SELECT orig, sum(R) acc2700 from `glassy-automata-358521.access.ratio` GROUP BY orig;
